    ...
    <div class="form-login">
        <div class="form-login-under">
            ...
            <div class="user-icon-container">
                <div class="icon-user-login">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="#183133" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="container-s1">
                <p class="font-tittle1">Bienvenido de nuevo</p>
                <p class="font-p">Accede a tu cuenta para participar en el foro</p>
            </div>
            <form action="">
                <div class="flexcolum">
                    <div class="inputForm">
